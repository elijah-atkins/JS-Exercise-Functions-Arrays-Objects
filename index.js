...
//     return index === idIn - 1;
//   });
//   return `This is a ${theId.car_make} ${theId.car_model}`;
// } // end getCarInfoById(
...
function getModelYears(inventory) {
  ...
  return modelYears;
  // return inventory.map(car => car.car_year); //forbidden
}
/**
...
function getOlderCars(inventory, n) {
  ...
  return olderCars;
  //  return inventory.filter(car => car.car_year <= n); //forbidden
}
...
// return inventory.filter(car => car.car_make === `Audi` ||              //forbidden
//                                car.car_make === `Mercedes-Benz` ||
//                                car.car_make === `Volkswagen`||
//                                car.car_make === `BMW`);
//     }
